...
合计: **2,763,785** 行代码（覆盖前 5 种语言、共 **12470** 个文件）。
...
- **Star**: 138,482 · **Fork**: 19,362 · **开放 issue**: 73,362 · **贡献者**: 2,397

## 累计统计

- **发布数**: 0 · **已合并 PR**: 1 · **开放 PR**: 535 · **已关闭 issue**: 63779 · **开放 issue**: 9583 · **提交数**: 67608
...
在 [repology.org](https://repology.org/project/go) 上共有 **1224** 个发行版报告此项目。**47** 个 ✅ 已是最新上游版本，**163** 个 ⚠️ 使用旧版本。

| 发行版 | 版本 | 状态 |
|--------|------|------|
| Debian unstable | `1.26.5` | 🪦 legacy |
| Debian 14 | `1.25.12` | 🪦 legacy |
| Debian 13 | `1.24.4` | ⚠️ outdated |
